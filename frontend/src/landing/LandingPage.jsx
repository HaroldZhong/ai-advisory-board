...
export default function LandingPage() {
    ...
    return (
        <div className="dark min-h-0 h-full overflow-y-auto overflow-x-hidden bg-slate-950 text-slate-50 font-sans selection:bg-indigo-500/30 scroll-smooth">
                ...
                <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
                    <div className="max-w-2xl">
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight mb-6">
                            Research and write with <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-emerald-400">your sources</span>
                        </h1>
                        <p className="text-lg md:text-xl text-slate-400 mb-8 leading-relaxed">
                            Bring documents into a conversation, inspect cited excerpts, and ask a council of models for another perspective when you need it.
                        </p>
                        ...
                        <ul className="space-y-3 mb-8 text-slate-300">
                            <li className="flex items-center gap-3">
                                ...
                                Ask the Council within the same conversation
                            </li>
                            <li className="flex items-center gap-3">
                                <div className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400">
                                    <MessageSquare className="w-4 h-4" />
                                </div>
                                Keep selected sources available for follow-up questions
                            </li>
                            <li className="flex items-center gap-3">
                                <div className="w-6 h-6 rounded-full bg-amber-500/20 flex items-center justify-center text-amber-400">
                                    <BarChart className="w-4 h-4" />
                                </div>
                                Set a session budget and inspect recorded costs
                            </li>
                        </ul>
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl backdrop-blur-sm">
                            ...
                            <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-800">
                                ...
                                <div className="text-xs font-mono text-slate-500">Council · illustrative workflow</div>
                            </div>
                                    ...
                                    <div className="bg-emerald-950/20 border border-emerald-900/30 rounded-lg p-4">
                                        <div className="flex items-center justify-between mb-3">
                                            <span className="text-xs font-bold text-emerald-400 flex items-center gap-1">
                                                <Shield className="w-3 h-3" /> CHECK THE SOURCES
                                            </span>
            ...
            <section className="py-20 bg-slate-950">
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-12">Keep evidence close to the answer</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 text-left">
                        <div className="bg-slate-900/50 p-6 rounded-xl border border-white/5">
                            ...
                            <p className="text-slate-300">Models can agree and still be <strong className="text-white">wrong</strong>. Check important claims against the source.</p>
                        </div>
                        <div className="bg-slate-900/50 p-6 rounded-xl border border-white/5">
                            <div className="w-10 h-10 bg-amber-500/10 rounded-lg flex items-center justify-center mb-4 text-amber-400">
                                <Search className="w-5 h-5" />
                            </div>
                            <p className="text-slate-300">Choose which documents inform your <strong className="text-white">next answer</strong>, while earlier answers retain their own source records.</p>
                        </div>
                        <div className="bg-slate-900/50 p-6 rounded-xl border border-white/5">
                    ...
                    <p className="mt-12 text-xl text-indigo-200 font-medium">
                        Explore perspectives, inspect evidence, and keep the result in one conversation.
                    </p>
                </div>
            </section>
            ...
            <section id="how-it-works" className="py-20 bg-slate-900/40 border-y border-white/5">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-400">Start with a conversation. Call the Council when another perspective would help.</p>
                    </div>
                    ...
                    <div className="relative grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        ...
                        <div className="relative bg-slate-950 p-8 rounded-2xl border border-slate-800 z-10">
                            ...
                            <p className="text-slate-400 text-center text-sm">Your selected council members answer the same question independently.</p>
                        </div>
                        ...
                        <div className="relative bg-slate-950 p-8 rounded-2xl border border-slate-800 z-10">
                            ...
                            <p className="text-slate-400 text-center text-sm">Models critique and rank anonymized answers. Their rankings express preferences, not verified accuracy.</p>
                        </div>
                        ...
                        <div className="relative bg-slate-950 p-8 rounded-2xl border border-slate-800 z-10">
                            ...
                            <p className="text-slate-400 text-center text-sm">A chairman synthesizes the responses. Read the answer first, then expand member responses and peer reviews.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-slate-950">
                <div className="container mx-auto px-4 max-w-6xl">
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { icon: Shield, title: "Inspect the evidence", desc: "Open the saved excerpt behind a citation.", sub: "Source records" },
                            { icon: Search, title: "More transparent decisions", desc: "See exactly how models ranked each other.", sub: "Full deliberation logs" },
                            { icon: MessageSquare, title: "Keep the conversation", desc: "Follow up with selected materials and retrieved history.", sub: "Materials and memory" },
                            { icon: BarChart, title: "Manage spending", desc: "Set a budget and inspect reported usage.", sub: "Unreported charges stay unknown" },
                        ].map((b, i) => (
            ...
            <section id="features" className="py-20 bg-slate-900/20">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 LG:grid-cols-3 gap-8">
                        {[
                            { title: "Conversation memory", desc: "Retrieve prior conversation context with topic filtering and model-assisted selection.", icon: Search },
                            { title: "Query Rewriting", desc: "Follow-ups rewritten to resolve pronouns and references before searching.", icon: MessageSquare },
                            { title: "Source inspection", desc: "Open cited excerpts and see when source coverage is incomplete.", icon: Shield },
                            { title: "Reasoning summaries", desc: "Inspect reasoning text when the provider returns it.", icon: Brain },
                            { title: "Cost Tracking", desc: "Recorded usage, session budgets, and spending alerts.", icon: BarChart },
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                "Draft a recommendation with citations and list the evidence still missing."
                            ].map((prompt, i) => (
                        ...
                        <div className="bg-slate-900/50 rounded-xl p-6 border border-white/5">
                            ...
                            <ul className="space-y-4">
                                {[
                                    "Member responses available to compare",
                                    "Anonymous ranking & critique",
                                    "Final synthesis by Chairman",
                                    "Citations linked to saved source excerpts",
                                    "Recorded costs and a session budget"
                                ].map((item, i) => (
...
# Open http://localhost:5173`}
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-400 mt-1">Desktop workspace, live stage updates, cost visibility.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-400 mt-1">Local conversation files, source records, and a JSON memory store.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="faq" className="py-20 bg-slate-950">
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="grid md:grid-cols-2 gap-12 mb-20">
                        <div>
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Separate answer, save, and memory status"
                                ].map((item, i) => (
                        ...
                        <div>
                            <h3 className="text-xl font-bold mb-6">A record you can inspect</h3>
                            <p className="text-sm leading-relaxed text-slate-400">Each answer keeps its own source excerpts and citation checks. Export the conversation with its evidence records for later review.</p>
                            <p className="mt-4 text-sm leading-relaxed text-slate-400">A citation match shows where text came from. You still decide whether it supports the claim.</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            { q: "Does agreement mean an answer is correct?", a: "No. Peer rankings and model self-assessments are not factual verification. Inspect the cited excerpts and check whether they actually support each claim." },
                            { q: "What models/providers can I use?", a: "Connect OpenRouter or a compatible API. Refresh the model picker to discover the configured provider's current models; available capabilities vary." },
                            { q: "Does it support multi-turn context?", a: "Yes. Selected files remain available for follow-ups, with retrieved conversation memory kept separate from source evidence." },
                            { q: "How do costs work?", a: "You bring your own API key. Council estimates are approximate; recorded charges and unreported costs are kept distinct." },
                            { q: "Can I self-host and control data?", a: "The app and conversation files run locally. Selected content is sent to your configured model provider for generation; provider retention policies apply." }
                        ].map((item, i) => (
            ...
            <section className="py-24 bg-gradient-to-b from-slate-950 to-indigo-950/20 text-center">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl font-bold mb-8">Ready to work with your sources?</h2>
                    ...
                    <p className="text-slate-400">Connect your provider. Add your materials. Start a conversation.</p>
                </div>
            </section>
